...
**Arquivo:** [sdn/auto_sdn.py](../sdn/auto_sdn.py)
...
|------|--------|---------|---------|-------------------|
| 1 — Flows proativos + isolamento | SDN | Baixo | Alto | [auto_sdn.py](../sdn/auto_sdn.py) |
| 2 — QoS diferenciado | Slicing | Baixo | Alto | [subscribers.js](../open5gs/seed/subscribers.js) |
| 3 — SDN dinâmico | SDN | Médio | Alto | [auto_sdn.py](../sdn/auto_sdn.py) |
...
| 5 — GTP-U awareness + Admission | SDN + Slicing | Alto | Alto | [auto_sdn.py](../sdn/auto_sdn.py), ONOS |
