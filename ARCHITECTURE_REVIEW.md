...
**Arquivo central:** [containernet/auto_sdn.py](containernet/auto_sdn.py)
...
No [containernet/auto_sdn.py](containernet/auto_sdn.py), após criar o switch e ligar os UEs, não há nenhuma chamada à API do ONOS para instalar flows:
...
1. Em [containernet/auto_sdn.py](containernet/auto_sdn.py), após `net.start()`, adicionar uma função `install_slice_flows()`:
...
| Arquivo | Relevância |
|---------|------------|
| [containernet/auto_sdn.py](containernet/auto_sdn.py) | Orquestrador SDN — ponto central de melhorias |
